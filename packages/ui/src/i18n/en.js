export default {
  ...
  canvas: {
    ...
    chatflow: 'Chatflow',
    exportAsTemplate: 'Export As Template',
    viewUpsertHistory: 'View Upsert History',
    configuration: 'Configuration',
    embedInWebsite: 'Embed in website or use as API',
    editName: 'Edit Name',
    apiEndpoint: 'API Endpoint',
    flowGenerationPrompt: 'What would you like to build?',
    flowGenerationDescription: 'Enter your prompt to generate an agentflow. Performance may vary with different models. Only nodes and edges are generated, you will need to fill in the input fields for each node.',
    viewMessages: 'View Messages',
    viewLeads: 'View Leads',
    pleaseSaveBeforeExporting: 'Please save the flow before exporting as template',
    exportAsTemplate: 'Export As Template',
    viewUpsertHistory: 'View Upsert History',
    configuration: 'Configuration',
    ...
    nodeOutdated: 'Node outdated',
    nodeDeprecated: 'This node will be deprecated in the next release. Change to a new node tagged with NEW',
    inputs: 'Inputs',
    output: 'Output',
    ...
    addNewTool: 'Add New Tool',
    addNewAssistant: 'Add New Assistant',
    pleaseFillAllMandatory: 'Please fill in all mandatory fields.',
    pleaseSelectKnowledgeBase: 'Please select a knowledge base',
    docStoreToolDescGenerated: 'Document Store Tool Description generated successfully',
    generateInstructions: 'Generate Instructions',
    instructionsPromptTemplate: 'You can generate a prompt template by sharing basic details about your task.',
    langchainHub: 'Langchain Hub',
    setupNIMLocally: 'Setup NIM Locally',
    generateKnowledgeBaseDesc: 'Generate knowledge base description',
    seeExample: 'See Example',
    ...
    errorSettingGeneratedInstruction: 'Error setting generated instruction',
    addNodes: 'Add Nodes',
    searchNodes: 'Search nodes',
    addNode: 'Add Node',
    generateAgentflow: 'Generate Agentflow',
    clearSearch: 'Clear Search',
    langchain: 'LangChain',
    ...
    additionalParameters: 'Additional Parameters',
    output: 'Output',
    nodeOutdatedMessage: 'Node version {{oldVersion}} outdated\nUpdate to latest version {{newVersion}}',
    nodeVersionEmptyMessage: 'Node outdated\nUpdate to latest version {{newVersion}}',
    nodeDeprecationMessage: 'This node will be deprecated in the next release. Change to a new node tagged with NEW',
    true: 'True',
    false: 'False'
  },
}