export default {
  ...
  canvas: {
    ...
    chatflow: '对话流',
    exportAsTemplate: '导出为模板',
    viewUpsertHistory: '查看更新历史',
    configuration: '配置',
    embedInWebsite: '嵌入网站或作为API使用',
    editName: '编辑名称',
    apiEndpoint: 'API端点',
    flowGenerationPrompt: '您想构建什么？',
    flowGenerationDescription: '输入您的提示以生成智能体流程。不同模型的性能可能会有所不同。只会生成节点和连接，您需要为每个节点填写输入字段。',
    viewMessages: '查看消息',
    viewLeads: '查看线索',
    pleaseSaveBeforeExporting: '导出为模板前请先保存流程',
    exportAsTemplate: '导出为模板',
    viewUpsertHistory: '查看更新历史',
    configuration: '配置',
    duplicateChatflow: '复制聊天流程',
    exportChatflow: '导出聊天流程',
    embedInWebsite: '嵌入网站或用作API',
    save: '保存',
    settings: '设置',
    saveNew: '新建保存',
    cancel: '取消',
    ...
    nodeOutdated: '节点已过时',
    nodeDeprecated: '此节点将在下一版本中被弃用。请更换为标有NEW的新节点',
    inputs: '输入',
    output: '输出',
    additionalParameters: '额外参数',
    addNewCredential: '添加新凭证',
    add: '添加',
    ...
    addNewTool: '添加新工具',
    addNewAssistant: '添加新助手',
    pleaseFillAllMandatory: '请填写所有必填字段。',
    pleaseSelectKnowledgeBase: '请选择一个知识库',
    docStoreToolDescGenerated: '文档存储工具描述生成成功',
    generateInstructions: '生成指令',
    instructionsPromptTemplate: '您可以通过分享任务的基本细节来生成提示模板。',
    langchainHub: 'Langchain Hub',
    setupNIMLocally: '本地设置NIM',
    generateKnowledgeBaseDesc: '生成知识库描述',
    seeExample: '查看示例',
    manageLinks: '管理链接',
    refresh: '刷新',
    toggleSnapping: '切换对齐',
    syncNodes: '同步节点',
    selectModel: '选择模型',
    errorSettingGeneratedInstruction: '设置生成指令时出错',
    addNodes: '添加节点',
    searchNodes: '搜索节点',
    addNode: '添加节点',
    generateAgentflow: '生成智能体流程',
    clearSearch: '清除搜索',
    langchain: 'LangChain',
    ...
    output: '输出',
    nodeOutdatedMessage: '节点版本 {{oldVersion}} 已过时\n请更新至最新版本 {{newVersion}}',
    nodeVersionEmptyMessage: '节点已过时\n请更新至最新版本 {{newVersion}}',
    nodeDeprecationMessage: '该节点将在下一版本中被弃用。请更换为带有NEW标签的新节点',
    true: '是',
    false: '否'
  },
}