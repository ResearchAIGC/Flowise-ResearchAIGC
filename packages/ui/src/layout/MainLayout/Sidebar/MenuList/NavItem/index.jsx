            ...
            <ListItemText
                primary={
                    <Typography
                        ...
                        sx={{ my: 0.5 }}
                    >
                        {item.id === 'tools' ? t('tools.title') : item.id === 'credentials' ? t('credentials.title') : item.id === 'variables' ? t('variables.title') : item.id === 'apikey' ? t('apikey.title') : t(item.id, item.title)}
                    </Typography>
                }
                secondary={
                    item.caption && (
